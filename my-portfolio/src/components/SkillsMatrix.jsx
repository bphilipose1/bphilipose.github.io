      ...
      <div className="grid grid-cols-1 md:grid-cols-3 gap-8">
        {skillGroups.map((group, i) => (
          ...
          >
            ...
            <div className="absolute -bottom-2 -right-2 text-[40px] font-mono text-slate-900 opacity-20 pointer-events-none group-hover:text-blue-500/10 transition-colors">
              0{i + 1}
            </div>
          </motion.div>
        ))}
